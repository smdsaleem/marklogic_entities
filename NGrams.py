...
if __name__=="__main__":
    #print Ngrams(u"This is a very small donkey.") * Ngrams(u"This animal is a very small donkey.")
    #print CharNgrams('supercalifragilistic')*CharNgrams('supercalifragislislistic')
    #print Ngrams(u"Morgan Stanley") * Ngrams(u"Mirgan Stanley")
    print CharNgrams('morgan stanley')*CharNgrams('mirgan stanley')
